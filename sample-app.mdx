...
<a href="" target="_blank" className="inline-flex items-center gap-3 border border-gray-400 h-7 px-5 py-5 rounded-xl hover:bg-gray-100 hover:dark:bg-gray-800">
